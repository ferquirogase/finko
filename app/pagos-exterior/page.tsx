    ...
    <div className="space-y-6">
      ...
      <div className="rounded-3xl bg-gradient-to-br from-amber-500 to-amber-600 p-8 text-white">
        ...
        <p className="mb-6 text-lg text-white/90">
          Compara las mejores plataformas para recibir pagos internacionales y maximiza tus ingresos como freelancer.
        </p>
      </div>
      ...
      <div className="rounded-3xl bg-white p-6 shadow-sm">
        <h2 className="mb-4 text-xl font-semibold text-gray-800">Preguntas frecuentes sobre cobros internacionales</h2>
