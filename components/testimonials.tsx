      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <div className="inline-block rounded-lg bg-purple-100 px-3 py-1 text-sm text-purple-800">Testimonios</div>
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <CardContent className="p-6">
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="space-y-2 text-center">
                  <h3 className="font-bold text-purple-900">Laura Martínez</h3>
                  <p className="text-sm text-purple-600">Diseñadora Web</p>
          ...
          <Card className="border-purple-100">
            <CardContent className="p-6">
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="space-y-2 text-center">
                  <h3 className="font-bold text-purple-900">Carlos Rodríguez</h3>
                  <p className="text-sm text-purple-600">Desarrollador Móvil</p>
                  <p className="text-sm text-gray-600">
          ...
          <Card className="border-purple-100">
            <CardContent className="p-6">
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="space-y-2 text-center">
                  <h3 className="font-bold text-purple-900">Ana García</h3>
                  <p className="text-sm text-purple-600">Marketing Digital</p>
                  <p className="text-sm text-gray-600">
          ...
          <Card className="border-purple-100 md:col-span-2 lg:col-span-3">
            <CardContent className="p-6">
              <div className="flex flex-col items-center space-y-4">
                <div className="flex flex-wrap justify-center gap-2">
                  <div className="rounded-full bg-purple-100 px-3 py-1 text-sm text-purple-800">Fácil de usar</div>
                  <div className="rounded-full bg-purple-100 px-3 py-1 text-sm text-purple-800">Ahorra tiempo</div>
                  <div className="rounded-full bg-purple-100 px-3 py-1 text-sm text-purple-800">Profesional</div>
                  <div className="rounded-full bg-purple-100 px-3 py-1 text-sm text-purple-800">Aumenta ingresos</div>
                  <div className="rounded-full bg-purple-100 px-3 py-1 text-sm text-purple-800">Confianza</div>
                </div>
